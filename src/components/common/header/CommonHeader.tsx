export const CommonHeader = () => (
    <header className={'flex items-center justify-between w-full px-4 p-2'}>
        ...
        <div className={'flex items-center justify-center gap-4'}>
            ...
            <button className={'flex items-center justify-center cursor-pointer px-[10px] py-[6px] border font-semibold border-gray-300 rounded text-gray-400 bg-white'}>북마크</button>
